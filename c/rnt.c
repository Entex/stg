...
const char *argp_program_version = "Random Node Tree 1.2";
const char *argp_program_bug_address = "rjak@kth.se"; //discontinued
static char doc[] = "RNT or Random Node Tree is a program that generates a spanning tree with random lengths between nodes used for calculating a spanning tree";
